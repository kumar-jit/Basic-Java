...
public class Trees_L15_NextLargerElement {

    static int nextLargerValue = Integer.MAX_VALUE;
    static TreeNode<Integer> nextLargerNode = null;
    public static TreeNode<Integer> findNextLargerNode(TreeNode<Integer> root, int n){

        // Write your code here
        if(root.data > n &&  root.data < nextLargerValue){
