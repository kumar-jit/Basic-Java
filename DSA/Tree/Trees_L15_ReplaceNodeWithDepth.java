...
public class Trees_L15_ReplaceNodeWithDepth {
    public static void replaceWithDepthValue(TreeNode<Integer> root,int height){
        root.data = height;
        for(int i = 0;i<root.children.size();i++){
            replaceWithDepthValue(root.children.get(i),height+1);
        }
    }
